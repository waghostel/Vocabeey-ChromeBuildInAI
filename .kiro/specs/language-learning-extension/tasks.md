...
- [x] 2. Implement Chrome Extension foundation
- [x] 2.1 Create manifest.json with required permissions
...
- [x] 2.2 Implement service worker background script
...
- [x] 2.3 Create content script for page interaction
...
- [x] 2.4 Write unit tests for extension foundation
...
- [x] 3. Implement content extraction pipeline
- [x] 3.1 Create Readability.js integration
  - Integrate Readability.js library for primary content extraction
  - Implement content validation and sanitization
  - Handle extraction failures gracefully
  - _Requirements: 1.1, 1.2, 1.3_

- [x] 3.2 Implement Jina Reader API fallback
...
- [x] 3.3 Create basic DOM parsing fallback
...
- [x] 4.3 Create Rewriter API for difficulty adaptation
...
- [x] 4.4 Implement Translator API for vocabulary translation
...
- [x] 4.5 Create Prompt API integration for vocabulary analysis
...
- [x] 4.6 Write unit tests for AI integration
  - Test each Chrome AI API integration
  - Test fallback mechanisms and error handling
  - Validate batch processing and caching
  - _Requirements: 2.1, 2.2, 3.2, 4.2_

- [x] 5. Implement Gemini API fallback system
- [x] 5.1 Create Gemini API client
...
- [x] 5.2 Implement AI service coordinator
...
- [x] 5.3 Write unit tests for fallback system
  - Test Gemini API integration
  - Test fallback chain functionality
  - Validate error handling and service coordination
  - _Requirements: 2.5, 9.1, 9.2_

- [x] 6. Create storage management system
- [x] 6.1 Implement versioned storage schema
...
- [x] 6.2 Create data migration system
...
- [x] 6.3 Implement cache management
...
- [x] 6.4 Create import/export functionality
...
- [x] 7.2 Implement vocabulary highlighting system
...
- [x] 7.3 Create sentence highlighting system
...
- [x] 7.4 Build vocabulary learning mode
...
- [x] 7.7 Write unit tests for UI components
...
- [x] 8. Implement settings and configuration
- [x] 8.1 Create first-time setup wizard
...
- [x] 8.2 Build settings interface
...
- [x] 8.4 Write unit tests for settings system
  - Test setup wizard functionality
  - Test settings persistence and validation
  - Validate API key management
  - _Requirements: 7.1, 7.2, 7.3, 7.4_

- [x] 9. Implement TTS and pronunciation features
- [x] 9.1 Create Web Speech API integration
...
- [x] 9.2 Add pronunciation controls
