...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes

Markdown Content:
chrome.enterprise.networkingAttributes | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#main-content)
...
- [English](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes)
- [Deutsch](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=de)
- [Español – América Latina](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=es-419)
- [Français](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=fr)
- [Indonesia](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=id)
- [Italiano](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=it)
- [Nederlands](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=nl)
- [Polski](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=pl)
- [Português – Brasil](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=pt-br)
- [Tiếng Việt](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=vi)
- [Türkçe](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=tr)
- [Русский](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=ru)
- [עברית](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=he)
- [العربيّة](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=ar)
- [فارسی](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=fa)
- [हिंदी](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=hi)
- [বাংলা](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=bn)
- [ภาษาไทย](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=th)
- [中文 – 简体](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=zh-cn)
- [中文 – 繁體](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=zh-tw)
- [日本語](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=ja)
- [한국어](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes?hl=ko)
...
- [enterprise.device Attributes](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes)
- [enterprise.hardware Platform](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform)
- [enterprise.login](https://developer.chrome.com/docs/extensions/reference/api/enterprise/login)
- [enterprise.networking Attributes](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes)
- [enterprise.platform Keys](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys)
...
- [extension Types](https://developer.chrome.com/docs/extensions/reference/api/extensionTypes)
- [file Browser Handler](https://developer.chrome.com/docs/extensions/reference/api/fileBrowserHandler)
- [file System Provider](https://developer.chrome.com/docs/extensions/reference/api/fileSystemProvider)
- [font Settings](https://developer.chrome.com/docs/extensions/reference/api/fontSettings)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#description)
- [Permissions](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#permissions)
- [Availability](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#availability)
- [Types](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#type)
  - [NetworkDetails](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#type-NetworkDetails)

- [Methods](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#method)
  - [getNetworkDetails()](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#method-getNetworkDetails)
...
chrome.enterprise.networking Attributes
...
This API is only for [extensions installed by a policy](https://support.google.com/chrome/a/answer/1375694).**Important:** This API works **only on ChromeOS**.
Description
...
chrome.enterprise.networkingAttributes.getNetworkDetails(): Promise<[NetworkDetails](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#type-NetworkDetails)>
...
- Promise<[NetworkDetails](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#type-NetworkDetails)> Chrome 96+
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes#)
