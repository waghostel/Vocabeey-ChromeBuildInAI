...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform

Markdown Content:
chrome.enterprise.hardwarePlatform | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#main-content)
...
- [English](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform)
- [Deutsch](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=de)
- [Español – América Latina](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=es-419)
- [Français](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=fr)
- [Indonesia](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=id)
- [Italiano](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=it)
- [Nederlands](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=nl)
- [Polski](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=pl)
- [Português – Brasil](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=pt-br)
- [Tiếng Việt](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=vi)
- [Türkçe](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=tr)
- [Русский](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=ru)
- [עברית](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=he)
- [العربيّة](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=ar)
- [فارسی](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=fa)
- [हिंदी](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=hi)
- [বাংলা](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=bn)
- [ภาษาไทย](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=th)
- [中文 – 简体](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=zh-cn)
- [中文 – 繁體](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=zh-tw)
- [日本語](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=ja)
- [한국어](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform?hl=ko)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#description)
- [Permissions](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#permissions)
- [Availability](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#availability)
- [Types](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#type)
  - [HardwarePlatformInfo](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#type-HardwarePlatformInfo)

- [Methods](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#method)
  - [getHardwarePlatformInfo()](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#method-getHardwarePlatformInfo)
...
chrome.enterprise.hardware Platform
...
chrome.enterprise.hardwarePlatform.getHardwarePlatformInfo(): Promise<[HardwarePlatformInfo](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#type-HardwarePlatformInfo)>
Obtains the manufacturer and model for the hardware platform and, if the extension is authorized, returns it via `callback`.

#### Returns

- Promise<[HardwarePlatformInfo](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#type-HardwarePlatformInfo)> Chrome 96+
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform#)
