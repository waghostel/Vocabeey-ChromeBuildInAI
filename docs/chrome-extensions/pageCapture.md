...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/pageCapture

Published Time: Mon, 11 Aug 2025 08:33:40 GMT

Markdown Content:
chrome.pageCapture | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/pageCapture#main-content)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/pageCapture#description)
- [Permissions](https://developer.chrome.com/docs/extensions/reference/api/pageCapture#permissions)
- [Methods](https://developer.chrome.com/docs/extensions/reference/api/pageCapture#method)
  - [saveAsMHTML()](https://developer.chrome.com/docs/extensions/reference/api/pageCapture#method-saveAsMHTML)
...
You must declare the "pageCapture" permission in the [extension manifest](https://developer.chrome.com/docs/extensions/reference/manifest) to use the pageCapture API. For example:
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/pageCapture#)
