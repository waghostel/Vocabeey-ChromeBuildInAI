...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/devtools/performance

Markdown Content:
chrome.devtools.performance | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#main-content)
...
- [English](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance)
- [Deutsch](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=de)
- [Español – América Latina](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=es-419)
- [Français](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=fr)
- [Indonesia](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=id)
- [Italiano](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=it)
- [Nederlands](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=nl)
- [Polski](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=pl)
- [Português – Brasil](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=pt-br)
- [Tiếng Việt](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=vi)
- [Türkçe](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=tr)
- [Русский](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=ru)
- [עברית](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=he)
- [العربيّة](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=ar)
- [فارسی](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=fa)
- [हिंदी](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=hi)
- [বাংলা](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=bn)
- [ภาษาไทย](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=th)
- [中文 – 简体](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=zh-cn)
- [中文 – 繁體](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=zh-tw)
- [日本語](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=ja)
- [한국어](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance?hl=ko)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#description)
- [Availability](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#availability)
- [Concepts and usage](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#concepts_and_usage)
- [Examples](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#examples)
- [Events](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#event)
  - [onProfilingStarted](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#event-onProfilingStarted)
  - [onProfilingStopped](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#event-onProfilingStopped)
...
The chrome.devtools.performance API allows developers to interact with the recording features of the **[Performance panel](https://developer.chrome.com/docs/devtools/performance)** panel in Chrome DevTools. You can use this API to get notifications when recording starts or stops.

Two events are available:

- [onProfilingStarted](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#event-onProfilingStarted): This event is fired when the **Performance** panel begins recording performance data.
- [onProfilingStopped](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#event-onProfilingStopped): This event is fired when the **Performance** panel stops recording performance data. stance that associates the current stack trace with the cre Both events don't have any associated parameters.
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/devtools/performance#)
