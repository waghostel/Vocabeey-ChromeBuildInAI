...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/devtools/network

Markdown Content:
chrome.devtools.network | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#main-content)
...
[Sign in](https://developer.chrome.com/_d/signin?continue=https%3A%2F%2Fdeveloper.chrome.com%2Fdocs%2Fextensions%2Freference%2Fapi%2Fdevtools%2Fnetwork&prompt=select_account)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#description)
- [Manifest](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#manifest)
- [Examples](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#examples)
- [Types](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#type)
  - [Request](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#type-Request)

- [Methods](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#method)
  - [getHAR()](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#method-getHAR)

- [Events](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#event)
  - [onNavigated](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#event-onNavigated)
...
(request: [Request](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#type-Request))=> void

    *   request [Request](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#type-Request)
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/devtools/network#)
