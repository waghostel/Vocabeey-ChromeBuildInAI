...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/printing
...
### get Printers() and get Printer Info()
...
chrome.printing.getPrinters(): Promise<[Printer](https://developer.chrome.com/docs/extensions/reference/api/printing#type-Printer)[]>
...
  request: [SubmitJobRequest](https://developer.chrome.com/docs/extensions/reference/api/printing#type-SubmitJobRequest),
...
- Promise<[SubmitJobResponse](https://developer.chrome.com/docs/extensions/reference/api/printing#type-SubmitJobResponse)> Chrome 100+
...
(jobId: string, status: [JobStatus](https://developer.chrome.com/docs/extensions/reference/api/printing#type-JobStatus))=> void
