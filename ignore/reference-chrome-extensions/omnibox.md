...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/omnibox

Markdown Content:
chrome.omnibox | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/omnibox#main-content)
...
[Case studies](https://developer.chrome.com/case-studies)More

[Blog](https://developer.chrome.com/blog)[New in Chrome](https://developer.chrome.com/new)
...
[![Image 3: Chrome for Developers](https://www.gstatic.com/devrel-devsite/prod/v90b15eef664021f94a1ab8a4ca14c533325a9006d6183b165fb79714a6fcd6a0/chrome/images/lockup.svg)](https://developer.chrome.com/)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/omnibox#description)
- [Manifest](https://developer.chrome.com/docs/extensions/reference/api/omnibox#manifest)
- [Examples](https://developer.chrome.com/docs/extensions/reference/api/omnibox#examples)
- [Types](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type)
  - [DefaultSuggestResult](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type-DefaultSuggestResult)
  - [DescriptionStyleType](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type-DescriptionStyleType)
...
- [Methods](https://developer.chrome.com/docs/extensions/reference/api/omnibox#method)
  - [setDefaultSuggestion()](https://developer.chrome.com/docs/extensions/reference/api/omnibox#method-setDefaultSuggestion)

- [Events](https://developer.chrome.com/docs/extensions/reference/api/omnibox#event)
  - [onDeleteSuggestion](https://developer.chrome.com/docs/extensions/reference/api/omnibox#event-onDeleteSuggestion)
  - [onInputCancelled](https://developer.chrome.com/docs/extensions/reference/api/omnibox#event-onInputCancelled)
  - [onInputChanged](https://developer.chrome.com/docs/extensions/reference/api/omnibox#event-onInputChanged)
  - [onInputEntered](https://developer.chrome.com/docs/extensions/reference/api/omnibox#event-onInputEntered)
  - [onInputStarted](https://developer.chrome.com/docs/extensions/reference/api/omnibox#event-onInputStarted)
...
![Image 4: A screenshot showing suggestions related to the keyword 'Chromium Search'](https://developer.chrome.com/static/docs/extensions/mv2/reference/omnibox/images/omnibox.png)
...
You must include an `"omnibox.keyword"` field in the [manifest](https://developer.chrome.com/docs/extensions/reference/manifest) to use the omnibox API. You should also specify a 16 by 16-pixel icon, which will be displayed in the address bar when suggesting that users enter keyword mode.
...
- deletable boolean optional Chrome 63+  
...
  suggestion: [DefaultSuggestResult](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type-DefaultSuggestResult),
...
(suggestResults: [SuggestResult](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type-SuggestResult)[])=> void

        *   suggestResults [SuggestResult](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type-SuggestResult)[]
...
(text: string, disposition: [OnInputEnteredDisposition](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type-OnInputEnteredDisposition))=> void

    *   text string
    *   disposition [OnInputEnteredDisposition](https://developer.chrome.com/docs/extensions/reference/api/omnibox#type-OnInputEnteredDisposition)
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/omnibox#)
