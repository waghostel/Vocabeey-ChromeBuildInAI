...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/action
...
  details: [TabDetails](https://developer.chrome.com/docs/extensions/reference/api/action#type-TabDetails),
...
chrome.action.getUserSettings(): Promise<[UserSettings](https://developer.chrome.com/docs/extensions/reference/api/action#type-UserSettings)>
...
  options?: [OpenPopupOptions](https://developer.chrome.com/docs/extensions/reference/api/action#type-OpenPopupOptions),
