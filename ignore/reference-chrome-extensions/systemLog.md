...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/systemLog

Markdown Content:
chrome.systemLog | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/systemLog#main-content)
...
- [English](https://developer.chrome.com/docs/extensions/reference/api/systemLog)
- [Deutsch](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=de)
- [Español – América Latina](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=es-419)
- [Français](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=fr)
- [Indonesia](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=id)
- [Italiano](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=it)
- [Nederlands](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=nl)
- [Polski](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=pl)
- [Português – Brasil](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=pt-br)
- [Tiếng Việt](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=vi)
- [Türkçe](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=tr)
- [Русский](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=ru)
- [עברית](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=he)
- [العربيّة](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=ar)
- [فارسی](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=fa)
- [हिंदी](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=hi)
- [বাংলা](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=bn)
- [ภาษาไทย](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=th)
- [中文 – 简体](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=zh-cn)
- [中文 – 繁體](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=zh-tw)
- [日本語](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=ja)
- [한국어](https://developer.chrome.com/docs/extensions/reference/api/systemLog?hl=ko)

[Sign in](https://developer.chrome.com/_d/signin?continue=https%3A%2F%2Fdeveloper.chrome.com%2Fdocs%2Fextensions%2Freference%2Fapi%2FsystemLog&prompt=select_account)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/systemLog#description)
- [Permissions](https://developer.chrome.com/docs/extensions/reference/api/systemLog#permissions)
- [Availability](https://developer.chrome.com/docs/extensions/reference/api/systemLog#availability)
- [Types](https://developer.chrome.com/docs/extensions/reference/api/systemLog#type)
  - [MessageOptions](https://developer.chrome.com/docs/extensions/reference/api/systemLog#type-MessageOptions)

- [Methods](https://developer.chrome.com/docs/extensions/reference/api/systemLog#method)
  - [add()](https://developer.chrome.com/docs/extensions/reference/api/systemLog#method-add)
...
  options: [MessageOptions](https://developer.chrome.com/docs/extensions/reference/api/systemLog#type-MessageOptions),
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/systemLog#)
