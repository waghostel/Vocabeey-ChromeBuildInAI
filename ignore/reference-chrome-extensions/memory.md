...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/system/memory

Markdown Content:
chrome.system.memory | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/system/memory#main-content)
...
- [English](https://developer.chrome.com/docs/extensions/reference/api/system/memory)
- [Deutsch](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=de)
- [Español – América Latina](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=es-419)
- [Français](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=fr)
- [Indonesia](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=id)
- [Italiano](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=it)
- [Nederlands](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=nl)
- [Polski](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=pl)
- [Português – Brasil](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=pt-br)
- [Tiếng Việt](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=vi)
- [Türkçe](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=tr)
- [Русский](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=ru)
- [עברית](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=he)
- [العربيّة](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=ar)
- [فارسی](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=fa)
- [हिंदी](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=hi)
- [বাংলা](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=bn)
- [ภาษาไทย](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=th)
- [中文 – 简体](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=zh-cn)
- [中文 – 繁體](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=zh-tw)
- [日本語](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=ja)
- [한국어](https://developer.chrome.com/docs/extensions/reference/api/system/memory?hl=ko)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/system/memory#description)
- [Permissions](https://developer.chrome.com/docs/extensions/reference/api/system/memory#permissions)
- [Types](https://developer.chrome.com/docs/extensions/reference/api/system/memory#type)
  - [MemoryInfo](https://developer.chrome.com/docs/extensions/reference/api/system/memory#type-MemoryInfo)

- [Methods](https://developer.chrome.com/docs/extensions/reference/api/system/memory#method)
...
chrome.system.memory.getInfo(): Promise<[MemoryInfo](https://developer.chrome.com/docs/extensions/reference/api/system/memory#type-MemoryInfo)>
Get physical memory information.

#### Returns

- Promise<[MemoryInfo](https://developer.chrome.com/docs/extensions/reference/api/system/memory#type-MemoryInfo)> Chrome 91+
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/system/memory#)
