...
URL Source: https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes

Published Time: Mon, 11 Aug 2025 08:33:40 GMT

Markdown Content:
chrome.enterprise.deviceAttributes | API | Chrome for Developers

===============
[Skip to main content](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#main-content)
...
- [English](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes)
- [Deutsch](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=de)
- [Español – América Latina](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=es-419)
- [Français](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=fr)
- [Indonesia](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=id)
- [Italiano](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=it)
- [Nederlands](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=nl)
- [Polski](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=pl)
- [Português – Brasil](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=pt-br)
- [Tiếng Việt](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=vi)
- [Türkçe](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=tr)
- [Русский](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=ru)
- [עברית](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=he)
- [العربيّة](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=ar)
- [فارسی](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=fa)
- [हिंदी](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=hi)
- [বাংলা](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=bn)
- [ภาษาไทย](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=th)
- [中文 – 简体](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=zh-cn)
- [中文 – 繁體](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=zh-tw)
- [日本語](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=ja)
- [한국어](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes?hl=ko)
...
- On this page
- [Description](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#description)
- [Permissions](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#permissions)
- [Availability](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#availability)
- [Methods](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#method)
  - [getDeviceAnnotatedLocation()](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#method-getDeviceAnnotatedLocation)
  - [getDeviceAssetId()](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#method-getDeviceAssetId)
  - [getDeviceHostname()](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#method-getDeviceHostname)
  - [getDeviceSerialNumber()](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#method-getDeviceSerialNumber)
  - [getDirectoryDeviceId()](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#method-getDirectoryDeviceId)
...
chrome.enterprise.device Attributes
...
- [Manage cookies](https://developer.chrome.com/docs/extensions/reference/api/enterprise/deviceAttributes#)
